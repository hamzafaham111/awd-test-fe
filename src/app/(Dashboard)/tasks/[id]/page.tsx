...
export default function TaskDetailsPage() {
  ...
  if (statusNum === 2) { // Inspector Assigned
    ...
    actionButtons = <div className="flex gap-2">
      <button className="bg-sky-700 text-white px-4 py-1 rounded-md">Mark As Completed</button>
      <button className="bg-sky-700 text-white px-4 py-1 rounded-md" onClick={() => router.push(`/tasks/${id}/inspection`)}>Resume Inspection</button>
    </div>;
  }
